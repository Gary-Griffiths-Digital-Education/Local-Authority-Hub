...
public class ServiceNameModel : PageModel
{
    ...
    {
        OpenReferralOrganisationWithServicesRecord openReferralOrganisation = await _openReferralOrganisationAdminClientService.GetOpenReferralOrganisationById(organisationid);
